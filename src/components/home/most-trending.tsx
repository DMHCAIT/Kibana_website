        ...
        >
          {trendingProducts.map((p) => (
            <Link
              ...
              href={`/shop/${p.slug}`}
              data-card
              className="flex-shrink-0 w-[calc(66.67vw-1rem)] sm:w-[calc(50vw-1rem)] md:w-[320px] h-[420px] sm:h-[400px] md:h-[480px] relative overflow-hidden rounded-xl group shadow-md sm:shadow-lg"
