...
export function AboutUs() {
  return (
    <section className="bg-kibana-cream overflow-hidden">
      ...
      <div className="sm:hidden container py-2">
        <div className="flex flex-col gap-1.5">
          {/* Text */}
          <div className="flex flex-col gap-1">
            <p className="text-[9px] tracking-[0.5em] uppercase text-kibana-camel font-medium">
              Our Story
            </p>
            <h2 className="font-bold uppercase tracking-[0.15em] text-base sm:text-lg leading-tight text-kibana-ink">
              Born from<br />Belief in Beauty
            </h2>
            <div className="w-6 h-px bg-kibana-tan my-0.5" />
            <p className="text-sm sm:text-base md:text-lg text-kibana-ink font-normal leading-relaxed">
            ...
            <Link
              href="/about"
              className="mt-0 inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-[0.2em] text-kibana-ink border border-kibana-ink px-3 py-1.5 w-fit hover:bg-kibana-ink hover:text-kibana-cream transition-colors duration-300"
            >
              Discover Our Story
            </Link>
          </div>
      ...
      <div className="hidden sm:grid sm:grid-cols-2">
        ...
        <div className="flex flex-col justify-center px-12 py-14 md:px-16 bg-kibana-cream">
          ...
          <p className="mt-3 text-sm sm:text-base md:text-lg text-kibana-ink font-normal leading-relaxed">
          ...
          <Link
            href="/about"
            className="mt-7 inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-[0.2em] text-kibana-ink border border-kibana-ink px-5 py-2.5 w-fit hover:bg-kibana-ink hover:text-kibana-cream transition-colors duration-300"
          >
            Discover Our Story
          </Link>
        </div>
