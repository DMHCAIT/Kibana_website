      ...
      <div className="sm:hidden container py-2">
        <div className="flex flex-col gap-1.5">
          ...
          <div className="flex flex-col gap-1">
            ...
            <h2 className="font-display text-xl leading-tight text-kibana-ink">
            ...
            <Link
              href="/about"
              className="mt-0 inline-flex items-center gap-2 text-xs font-bold uppercase tracking-[0.2em] text-kibana-ink border border-kibana-ink px-3 py-1.5 w-fit hover:bg-kibana-ink hover:text-kibana-cream transition-colors duration-300"
            >
              Discover Our Story
            </Link>
          </div>
